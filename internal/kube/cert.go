...
var (
	...
	promCertCreateCounter   prometheus.Counter
)
...
func init() {
	...
	promCertCreateCounter = promauto.NewCounter(prometheus.CounterOpts{Name: "cms_certificate_create_total", Help: "Count of certificates created"})
}
